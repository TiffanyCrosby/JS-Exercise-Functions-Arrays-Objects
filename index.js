...
console.log(makePersonObject(45, 'Tiffany', 'tiffany@tiffany.com'));
...
just gives me that there is a function [Function: sum]
doesn't actually give value!!!!!!!!!!!!!!!???????????????????????????????????????????*/
console.log(makeSmartPerson('Tiffany'));
/*
